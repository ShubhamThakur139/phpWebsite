...
<div class="col-sm-6 mt-4 mx-3 jumbotron">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="courseOriginalPrice" id="courseOriginalPrice" value="<?php if (isset($row['course_original_price'])) {
                                                                                                                    echo $row['course_original_price'];
                                                                                                                } ?>">
        </div>
        <div class="form-group">
            <label for="coursePrice">Course Selling Price</label>
            <input type="text" class="form-control" name="coursePrice" id="coursePrice" value="<?php if (isset($row['course_price'])) {
